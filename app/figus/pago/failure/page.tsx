  ...
  return (
    <FiguShell>
      <section className="rounded-[2.5rem] bg-white p-8 text-center shadow-sm ring-1 ring-slate-200">
        <p className="text-sm font-black uppercase tracking-[0.25em] text-red-600">Mercado Pago</p>
        <h1 className="mt-3 text-4xl font-black text-[#0D1B2A]">Pago rechazado</h1>
        <p className="mx-auto mt-3 max-w-2xl text-sm font-semibold leading-6 text-slate-500">Mercado Pago no pudo aprobar el pago. Podés volver a intentar desde Suscripción.</p>
